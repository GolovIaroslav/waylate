...
pub fn catalog() -> Vec<ModelProfile> {
    vec![
        ModelProfile {
            ...
            description: "Recommended first local model. After one download it works offline and covers many languages.".into(),
            quantization: "Balanced".into(),
            size: "~2.4 GB".into(),
            homepage: "https://huggingface.co/entai2965/nllb-200-distilled-600M-ctranslate2".into(),
            engine_hint: "Waylate downloads the model, prepares the local runtime automatically, and then keeps translation inside the app.".into(),
        ...
        ModelProfile {
            ...
            description: "Compact multilingual GGUF model with better quality than tiny models while staying relatively small.".into(),
            quantization: "1.25-bit GGUF".into(),
            size: "~440 MB".into(),
            homepage: "https://huggingface.co/tencent/Hy-MT2-1.8B-1.25Bit-GGUF".into(),
            engine_hint: "Waylate downloads the curated GGUF file and runs it through the built-in managed local runtime path.".into(),
            default_endpoint: None,
        ...
        ModelProfile {
            ...
            provider: ProviderKind::Custom,
            description: "Higher-quality GGUF option for broader translation work if your machine has enough RAM and disk space.".into(),
            quantization: "Q4_K_M GGUF".into(),
            size: "~3.0 GB".into(),
            homepage: "https://huggingface.co/bullerwins/translategemma-4b-it-GGUF".into(),
            engine_hint: "Waylate downloads the curated Q4_K_M file and runs it through the managed local runtime path.".into(),
            default_endpoint: None,
        ...
        ModelProfile {
            ...
            provider: ProviderKind::Custom,
            description: "Small GGUF model with a good size-to-quality balance and support for Slovak and many common languages.".into(),
            quantization: "Q4_K_M GGUF".into(),
            size: "~1.1 GB".into(),
